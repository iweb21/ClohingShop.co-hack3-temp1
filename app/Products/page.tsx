...
//             setError("There was an issue fetching the products. Please try again later.");
//         }
//     };

//     // Add product to cart, checking if it's already added
//     const addToCart = (product: Product) => {
//         setCart((prevCart) => {
//             const isProductInCart = prevCart.some((item) => item._id === product._id);
//             if (isProductInCart) {
//                 alert(`${product.name} is already in your cart`);
//                 return prevCart; // Do not add duplicate product
//             }
...
//     // Truncate description to a max length of 100 characters
